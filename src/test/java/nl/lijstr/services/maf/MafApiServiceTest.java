...
public class MafApiServiceTest {
    ...
    public void updateMovie() throws Exception {
        ...
        when(imdbService.getMovie(anyString(), eq(imdbId), anyString(), anyString(), anyInt(), anyInt(), anyInt()))
        ...
        verify(imdbService, times(1)).getMovie(anyString(), eq(imdbId), anyString(), anyString(), anyInt(), anyInt(), anyInt());
