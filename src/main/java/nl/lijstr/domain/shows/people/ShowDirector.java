...
/**
 * A link between a {@link Show} and an IMDB {@link Person} who has <strong>directed</strong> that movie.
 */
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
@Entity
public class ShowDirector extends IdModel implements PersonBound {
